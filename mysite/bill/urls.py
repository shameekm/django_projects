...
urlpatterns = [
    ...
    path('reciept/<int:pk>/delete', views.RecieptDeleteView.as_view(), name='reciept_delete'),
    path('reciept/<int:pk>/person', views.PersonCreateView.as_view(), name='reciept_person_create'),
    path('person/<int:pk>/delete', views.PersonDeleteView.as_view(), name='reciept_person_delete'),
